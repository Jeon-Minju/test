...
// CONCATENATED MODULE: ./components/chat/message.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Message, _Component);

  function Message() {
    Object(classCallCheck["a" /* default */])(this, Message);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Message).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(Message, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          data = _this$props.data,
          isMine = _this$props.isMine,
          startsSequence = _this$props.startsSequence,
          endsSequence = _this$props.endsSequence,
          showTimestamp = _this$props.showTimestamp;
      var friendlyTimestamp = external_moment_default()(data.timestamp).format('LLLL');
      return external_react_default.a.createElement("div", {
        className: ['message', "".concat(isMine ? 'mine' : ''), "".concat(startsSequence ? 'start' : ''), "".concat(endsSequence ? 'end' : '')].join(' ')
      }, showTimestamp && external_react_default.a.createElement("div", {
        className: "timestamp"
      }, friendlyTimestamp), external_react_default.a.createElement("div", {
...
// CONCATENATED MODULE: ./components/chat/messagelist.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(MessageList, _Component);

  function MessageList(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, MessageList);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(MessageList).call(this, props));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getMessages", function () {
  ...
  Object(createClass["a" /* default */])(MessageList, [{
    ...
    value: function renderMessages() {
      ...
      while (i < messageCount) {
        ...
        var currentMoment = external_moment_default()(current.timestamp);
        ...
        if (previous) {
          var previousMoment = external_moment_default()(previous.timestamp);
          var previousDuration = external_moment_default.a.duration(currentMoment.diff(previousMoment));
        ...
        if (next) {
          var nextMoment = external_moment_default()(next.timestamp);
          var nextDuration = external_moment_default.a.duration(nextMoment.diff(currentMoment));
        ...
        messages.push(external_react_default.a.createElement(message_Message, {
          key: i,
          isMine: isMine,
...
function (_React$Component) {
  Object(inherits["a" /* default */])(Chatting, _React$Component);

  function Chatting() {
    Object(classCallCheck["a" /* default */])(this, Chatting);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Chatting).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(Chatting, [{
    key: "render",
    value: function render() {
      var classes = this.props.classes;
      return external_react_default.a.createElement(messagelist_MessageList, null);
    }
  }]);
...
/* harmony default export */ var chat = __webpack_exports__["a"] = (chat_Chatting);
...
// EXTERNAL MODULE: ./components/chat/index.js + 2 modules
var chat = __webpack_require__("2KJv");
...
function ChatbotModification() {
  ...
  }), external_react_default.a.createElement(chat["a" /* default */], null)));
}
...
var reservation_styles = function styles(theme) {
  return {
    ...
    contentHeader: Object(defineProperty["a" /* default */])({
      display: "flex",
      marginBottom: "20px"
    }, theme.breakpoints.up("sm"), {
      paddingLeft: theme.spacing(3)
    }),
    flexGrid: Object(defineProperty["a" /* default */])({
      display: "flex"
    }, theme.breakpoints.up("sm"), {
      paddingLeft: theme.spacing(3),
  ...
  Object(createClass["a" /* default */])(Reservation, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(styles_["MuiThemeProvider"], {
        ...
        variant: "h6",
        component: "h6"
      }, external_react_default.a.createElement(ArrowBack_default.a, null), "\uB4A4\uB85C\uAC00\uAE30")))), external_react_default.a.createElement(Hidden_default.a, {
        mdUp: true
        ...
        display: "inline",
        align: "center"
      }, "\uC601\uC5C5\uC77C"), external_react_default.a.createElement(Typography_default.a, {
        component: "p",
        display: "inline",
        align: "center"
      }, "2019\uB144 6\uC6D4 22\uC77C"), external_react_default.a.createElement(Typography_default.a, {
        component: "p",
        display: "inline",
        align: "center"
      }, "\uCD5C\uADFC\uC218\uC815\uC77C"), external_react_default.a.createElement(Typography_default.a, {
        component: "p",
        display: "inline",
        align: "center"
