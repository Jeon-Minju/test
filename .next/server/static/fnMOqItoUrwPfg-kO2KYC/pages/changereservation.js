...
function ChatbotModification(props) {
  ...
  var _React$useState = external_react_default.a.useState(false),
      ...
      activeClass = _React$useState2[0],
      setActiveClass = _React$useState2[1];

  function handleToggle01() {
    setActiveClass(!activeClass);
  }

  var addClass = this.state.activeClass ? 'on' : null;
  return external_react_default.a.createElement(external_react_default.a.Fragment, {
    ...
    className: classes.onoffButton + addClass,
    onclick: function onclick() {
      return handleToggle01();
    }
  }, "\uD3EC\uC7A5"), external_react_default.a.createElement("button", {
    className: classes.onoffButton + addClass,
    onclick: function onclick() {
      return handleToggle01();
    }
  }, "\uBCF4\uB0C4")) : null), external_react_default.a.createElement(Divider_default.a, {
    light: true
  }), external_react_default.a.createElement("div", {
