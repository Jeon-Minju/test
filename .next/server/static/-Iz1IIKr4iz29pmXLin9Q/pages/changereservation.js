...
function ChatbotModification(props) {
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, {
    ...
    className: classes.onoffButton + 'on',
    onclick: function onclick() {
      return handleToggle01();
    }
  }, "\uD3EC\uC7A5"), this.state.isToggleOn ? 'ON' : 'OFF', external_react_default.a.createElement("button", {
    className: classes.onoffButton,
    onclick: function onclick() {
      return handleToggle01();
    }
  }, "\uBCF4\uB0C4"), this.state.isToggleOn ? 'ON' : 'OFF') : null), external_react_default.a.createElement(Divider_default.a, {
    light: true
  }), external_react_default.a.createElement("div", {
