...
var GlobalCss = Object(styles_["withStyles"])({
  ...
  }, Object(defineProperty["a" /* default */])(_global, ".MuiInput-underline", {
    '&:hover': {
      '&:not(.Mui-disabled)': {
        '&:before': {
          border: "none"
  ...
  }), Object(defineProperty["a" /* default */])(_global, '.MuiInputAdornment-root.MuiIconButton-root', {
    color: "#297bff"
  }), _global)
})(function () {
  return null;
...
var rows = [createData(1, '마카롱', '작고 맛있어요', '10000원'), createData(2, '마카롱', '써요', '10000원'), createData(3, '카페라떼', '달아요', '10000원')];
